                            ...
                            <View style={{ alignItems: 'center' }}>
                                ...
                                <View style={{ flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', paddingHorizontal: 40, paddingBottom: 25 }}>
                                    ...
                                    <View style={{ paddingHorizontal: 40, paddingBottom: 20 }}>
                                        <Text numberOfLines={4} style={{ fontFamily: 'Roboto-Regular', fontSize: 12, color: 'white' }}>{get(item, 'description')}</Text>
                                    </View>
                            ...
                            return (
                                <TouchableOpacity activeOpacity={1} style={{ flexDirection: "row", alignItems: 'center', borderTopWidth: 0.3, borderColor: 'grey', paddingVertical: 10 }} onPress={() => props.navigation.navigate('EpisodeDetails')}>
                                    ...
                                    <View style={{ paddingLeft: 18 }}>
                                        ...
                                        <View style={{ flexWrap: 'wrap', paddingRight: 36 }}>
                                            <Text numberOfLines={1} style={{ fontFamily: 'Roboto-Regular', fontSize: 18, color: '#000', paddingTop: 2, paddingRight: 36 }}>{get(item, 'title')}</Text>
                                            <Text numberOfLines={1} style={{ fontFamily: 'Roboto-Regular', fontSize: 12, color: 'grey', paddingTop: 2 }}>{get(item, 'description')}</Text>
                                        </View>

...
export default HeaderSearch = (props) => {
    return (
        <View style={{ padding: 18, flexDirection: 'row', alignItems: 'center' }}>
            <View style={{ flex:1, flexDirection: 'row', backgroundColor: '#f2f1f0', borderRadius: 15, padding: 10, alignItems: 'center' }}>
                <Image style={{ height: 20, width: 20, resizeMode: "contain" }} source={search} />
                <TextInput style={{ flex: 1, paddingHorizontal: 10, fontFamily: 'Roboto-Regular' }} placeholder={'Search Podcasts'} placeholderTextColor={'black'} />
